...
git clone https://github.com/prankevich/TODO.git
cd TODO
go mod tidy

🔧 Настройка

Создай файл .env и укажи параметры:

TELEGRAM_TOKEN=your_bot_token
POSTGRES_URL=postgres://user:password@localhost:5432/todo?sslmode=disable
...
Расширить возможности редактирования задач
